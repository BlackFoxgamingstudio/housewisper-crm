# Changelog — Sovereign HouseWisper CRM
...
### Added
- Initial production release of Sovereign HouseWisper CRM (PKG-027)
- Core microservice on port `8807`
- n8n webhook adapter (`n8n/webhook_adapter.py`)
- REST API (`POST /api/v1/execute`, `GET /health`)
- Components: LeadNurturer, ValuationEngine, AppointmentScheduler, OfferTracker, MarketAnalyzer
- pyproject.toml packaging with `[dev]` extras
- CLI: `sovereign-housewisper-crm --help`
...
[Unreleased]: https://github.com/BlackFoxgamingstudio/housewisper-crm/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/BlackFoxgamingstudio/housewisper-crm/releases/tag/v1.0.0
