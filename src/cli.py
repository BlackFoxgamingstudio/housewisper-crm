#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-housewisper-crm
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Real estate CRM automation and buyer workflow assistant. Connects BoldTrail and Follow Up Boss APIs with Google Cloud Build, managing listing inquiry routing, automated client follow-ups, and transaction milestone tracking.")
